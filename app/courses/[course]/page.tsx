...
import GitVisualizer from '@/app/components/GitVisualizer'
        ...
        <div className='flex'>
            <div className='flex-col w-2/12 bg-gray-100 px-4 h-dvh'>
                ...
                <div className='flex-col divide-y-2 divide-gray-300 items-center pr-6'>
                    <div className='py-3 font-medium cursor-pointer hover:underline underline-offset-1'>Step 1</div>
                    ...
                    <div onClick={(e: any) => setTab('Git Visualizer')} className='py-3 font-medium cursor-pointer hover:underline underline-offset-1'>Git Visualizer</div>
                </div>
            </div>
